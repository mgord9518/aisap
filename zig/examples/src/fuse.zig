...
pub const Operations = extern struct {
    ...
    readlink: ?*const fn ([*:0]const u8, [*:0]u8, usize) callconv(.C) E = null,
    ...
    rename: ?*const fn ([*:0]const u8, [*:0]const u8, c_uint) callconv(.C) E = null,
    ...
    setxattr: ?*const fn ([*:0]const u8, [*:0]const u8, [*:0]const u8, usize, c_int) callconv(.C) E = null,
    getxattr: ?*const fn ([*:0]const u8, [*:0]const u8, [*:0]u8, usize) callconv(.C) E = null,
    listxattr: ?*const fn ([*:0]const u8, [*:0]u8, usize) callconv(.C) E = null,
    removexattr: ?*const fn ([*:0]const u8, [*:0]const u8) callconv(.C) E = null,
    opendir: ?*const fn ([*:0]const u8, *FileInfo) callconv(.C) E = null,
    readdir: ?*const fn ([*:0]const u8, *anyopaque, FillDir, linux.off_t, *FileInfo, ReadDirFlags) callconv(.C) E = null,
